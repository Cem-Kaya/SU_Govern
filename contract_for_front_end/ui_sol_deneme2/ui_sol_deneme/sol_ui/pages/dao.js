...
export default function Dao() {
  ...
  const init = async () => {
    ...
    daoContract = new web3.eth.Contract(daoABI, address);
    ...
    voterToken = new web3.eth.Contract(dataToken["abi"], voterTokenAddress);
    ykToken = new web3.eth.Contract(dataToken["abi"], ykTokenAddress);
  ...
  const Create_proposal = async (name, vote, power) => {
    ...
    await daoContract.methods
      .createProposal(name, vote, initial_votes, power, 0)
  ...
  const SendVoterTokens = async (address, amount) => {
    ...
    await daoContract.methods
      .send_voter_tokens_to_address_yk_directly(address, amount)
      .send({ from: selectedAccount })
      .then(() => {
  ...
  const SendYKTokens = async (address, amount) => {
    ...
    await daoContract.methods
      .send_yk_tokens_to_address_yk_directly(address, amount)
      .send({ from: selectedAccount })
      .then(() => {
        setAlertMessage({ text: "Successfully sent tokens", title: "Success" });
        setPopupTrigger(true);
  ...
  const GetYKSharesToBeGiven = async () => {
    ...
    let shares;
    await daoContract.methods
      .yk_shares_to_be_given(selectedAccount)
      .call()
      .then((result) => {
        shares = result;
      })
  ...
  const GetVoterSharesToBeGiven = async () => {
    ...
    let shares;
    await daoContract.methods
      .voter_shares_to_be_given(selectedAccount)
      .call()
      .then((result) => {
        shares = result;
      })
  ...
  const getHTMLBody = () => {
    return selectedNavItem === 0 ? (
      ...
      <VoteOnProposals
        to_vote_power={to_vote_power}
        all_props={all_props}
        setcurrAmountOfVotes={setSelection}
        currAmountOfVotes={selection}
      ></VoteOnProposals>
    ) : selectedNavItem === 7 ? (
      <WithdrawTokens
        ...
        <div className="row mx-0">
            ...
            <div className="container-fluid p-2">
              ...
              <div className="input-group mb-3">
                ...
                <div className="input-group-append">
                  <button
                    className="btn btn-secondary btn-outline-white rounded-0"
                    type="button"
                  >
                    Button
                  </button>
              ...
              <div className="list-group" id="list-tab" role="tablist">
                <button
                  ...
                  className="list-group-item list-group-item-action bg-transparent border border-white text-white mb-2"
                  id="list-home-list"
                  data-bs-toggle="list"
                  href="#list-home"
                  role="tab"
            ...
            <ul className="nav flex-column my-2">
              ...
              <li className="nav-item">
                <a className="nav-link" href="#">
                  Reserve Extra Tokens (not implemented)
                </a>
              </li>
              <li className="nav-item">
                <a
          ...
          <div className="col-9">
            <div className="container" style={{ padding: "30px" }}>
              ...
              <div className="row mt-5">{getHTMLBody()}</div>
            </div>
          </div>
        </div>
      </div>
