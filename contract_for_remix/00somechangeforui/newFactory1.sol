...
contract DAOFactory {
    ...
    function createDAOTop( string memory dao_name,string memory dao_image , string memory dao_description, string memory yk_token_name, string memory yk_token_symbol, string memory voter_token_name, string memory voter_token_symbol) public {
        ...
        MyDAO c = new MyDAO(dao_name,dao_image, dao_description,next_dao_id, msg.sender, yk_token, voter_token, this);
    ...
    function createChildDAO( MyDAO parent, string memory dao_name,string memory dao_image,  string memory dao_description, string memory yk_token_name, string memory yk_token_symbol, string memory voter_token_name, string memory voter_token_symbol) public {
