...
contract MyDAO {
    ...
    constructor(string memory _dao_name,string memory _dao_image, string memory _dao_description,uint _dao_id, address first_yk, ISUToken yk_token_in, ISUToken voter_token_in, DAOFactory _factory) {
        factory = _factory;
        dao_name = _dao_name;
        dao_id=_dao_id;
        dao_image=_dao_image;
