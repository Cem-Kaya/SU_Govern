...
contract DAOFactory {
    ...
    mapping(MyDAO => SUToken) public dao_tokens_yk;
    mapping(MyDAO => SUToken) public dao_tokens_voter;
    mapping(MyDAO => address) public dao_first_yk;
    mapping(SUToken => address) public token_first_yk;
    ...
    function mint_dao_address(MyDAO to_be_minted, uint amount) public{
