...
contract DAOFactory {
    ...
    function createDAOTop( string memory dao_name,  string memory dao_description, string memory yk_token_name, string memory yk_token_symbol, string memory voter_token_name, string memory voter_token_symbol, address temp1, address temp2) public {
        ...
        ISUToken yk_token = ISUToken(temp1);
        ISUToken voter_token = ISUToken(temp2);
    ...
    function createChildDAO( MyDAO parent, string memory dao_name,  string memory dao_description, string memory yk_token_name, string memory yk_token_symbol, string memory voter_token_name, string memory voter_token_symbol, address temp1, address temp2) public {
